...
HD_PWD='C:/Users/recep/project_3_Led_Kaydirma/project_3_Led_Kaydirma.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BCD_7_Segment.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BCD_7_Segment.tcl
