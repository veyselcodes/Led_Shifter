...
HD_PWD='C:/Users/recep/project_3_Led_Kaydirma/project_3_Led_Kaydirma.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log BCD_7_Segment.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source BCD_7_Segment.tcl -notrace
